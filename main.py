...
class Agent(pygame.sprite.Sprite):
    ...
    def check_death(self):
        if self.time_alive > Death_rate.val:
            self.kill()
        if self.temperature < -5 or self.temperature > 40:
            self.lives -= 1
...
seasons_north = {"January":(-12,-7),"February":(-13,-7),"March":(-11,-6), "April":(-7,0),"May":(0,6),"June":(5,12),"July":(7,14),"August":(6,12),"September":(3,8),"October":(-2,2),"November":(-7,-3),"December":(-11,-6)}
seasons_temperate_north = {"January":(0,5),"February":(0,6),"March":(1,10), "April":(5,15),"May":(10,19),"June":(13,23),"July":(16,26),"August":(15,24),"September":(12,21),"October":(8,16),"November":(4,10),"December":(0,6)}
seasons_tropical_north = {"January":(19,30),"February":(21,32),"March":(23,33), "April":(24,35),"May":(26,36),"June":(26,36),"July":(25,35),"August":(25,34),"September":(25,34),"October":(25,34),"November":(22,32),"December":(20,30)}
seasons_tropical_south = {"January":(21,30),"February":(21,30),"March":(21,30), "April":(21,30),"May":(19,29),"June":(18,28),"July":(17,28),"August":(18,29),"September":(19,30),"October":(20,30),"November":(21,30),"December":(21,30)}
seasons_temperate_south = {"January":(12,22),"February":(11,22),"March":(10,20), "April":(7,18),"May":(5,14),"June":(3,12),"July":(2,12),"August":(3,13),"September":(4,15),"October":(7,17),"November":(8,19),"December":(10,21)}
seasons_south = {"January":(-2,3),"February":(-3,2),"March":(-8,-1), "April":(-12,-5),"May":(-15,-7),"June":(-16,-8),"July":(-16,-8),"August":(-15,-7),"September":(-13,-6),"October":(-11,-4),"November":(-6,0),"December":(-3,2)}
...
Death_rate = Slider("Lifespan", 20, 360, 1, 360)
